...
/*================================================*/
{
	...
	fprintf(stderr, "%s[%d] [tid: %lu]: Creating/Checking the foreign constraint tables(SYS_FOREIGN/SYS_FOREIGN_COLS) in the InnoDB...\n", __FILE__, __LINE__, pthread_self());
	...
	if (table1 && table2
		...
		fprintf(stderr, "%s[%d] [tid: %lu]: The foreign constraint tables(SYS_FOREIGN/SYS_FOREIGN_COLS) have already been created, and they are ok.\n", __FILE__, __LINE__, pthread_self());
	...
	fprintf(stderr, "%s[%d] [tid: %lu]: The foreign constraint tables(SYS_FOREIGN/SYS_FOREIGN_COLS) must been created.\n", __FILE__, __LINE__, pthread_self());
