...
static handler *innobase_create_handler(handlerton *hton,
                                        ...
                                        MEM_ROOT *mem_root)
{
  sql_print_information("%s[%d] [tid:%lu]: Creating a table Handler {db = %s, table = %s}.", __FILE__, __LINE__, pthread_self(),
		  table? table->db.str:"NULL", table? table->table_name.str:"NULL");
...
ha_innobase::ha_innobase(handlerton *hton, TABLE_SHARE *table_arg)
  ...
  num_write_row(0)
{
	sql_print_information("%s[%d] [tid:%lu]: Instancing a table Handler {db = %s, table = %s}.", __FILE__, __LINE__, pthread_self(),
			table_arg? table_arg->db.str:"NULL", table_arg? table_arg->table_name.str:"NULL");
}
	...
	void	*p)	/*!< in: InnoDB handlerton */
{
	...
	sql_print_information("%s[%d] [tid:%lu]: default_path = %s.", __FILE__, __LINE__, pthread_self(), default_path);
	...
	sql_print_information("%s[%d] [tid:%lu]: srv_data_home = %s.", __FILE__, __LINE__, pthread_self(), srv_data_home);
	...
	sql_print_information("%s[%d] [tid:%lu]: innobase_data_file_path = %s.", __FILE__, __LINE__, pthread_self(), innobase_data_file_path);
	...
	sql_print_information("%s[%d] [tid:%lu]: internal_innobase_data_file_path = %s.", __FILE__, __LINE__, pthread_self(), internal_innobase_data_file_path);
...
mem_free_and_error:
	...
	sql_print_information("%s[%d] [tid:%lu]: innobase_log_group_home_dir = %s.", __FILE__, __LINE__, pthread_self(), innobase_log_group_home_dir);
	...
	sql_print_information("%s[%d] [tid:%lu]: innobase_file_format_name = %s.", __FILE__, __LINE__, pthread_self(), innobase_file_format_name);
	...
	sql_print_information("%s[%d] [tid:%lu]: innobase_file_format_name = %s, srv_file_format = %d, innobase_file_format_check = %s.", __FILE__, __LINE__, pthread_self(), innobase_file_format_name, srv_file_format, innobase_file_format_check);
	...
	sql_print_information("%s[%d] [tid:%lu]: innobase_change_buffering = %s.", __FILE__, __LINE__, pthread_self(), innobase_change_buffering);
...
innobase_change_buffering_inited_ok:
	...
	sql_print_information("%s[%d] [tid:%lu]: srv_file_flush_method_str = %s, srv_n_log_groups = %u, srv_n_log_files = %u, srv_log_file_size = %u.",
			__FILE__, __LINE__, pthread_self(),
			srv_file_flush_method_str, srv_n_log_groups, srv_n_log_files, srv_log_file_size);
	...
	sql_print_information("%s[%d] [tid:%lu]: srv_log_buffer_size = %u, srv_buf_pool_size = %u, srv_mem_pool_size = %u.",
					__FILE__, __LINE__, pthread_self(),
					srv_log_buffer_size, srv_buf_pool_size, srv_mem_pool_size);

	srv_n_file_io_threads = (ulint) innobase_file_io_threads;
	srv_n_read_io_threads = (ulint) innobase_read_io_threads;
	srv_n_write_io_threads = (ulint) innobase_write_io_threads;

	sql_print_information("%s[%d] [tid:%lu]: srv_n_file_io_threads = %u, srv_n_read_io_threads = %u, srv_n_write_io_threads = %u.",
					__FILE__, __LINE__, pthread_self(),
	...
	sql_print_information("%s[%d] [tid:%lu]: srv_force_recovery = %u, srv_use_doublewrite_buf = %d, srv_use_checksums = %d.",
						__FILE__, __LINE__, pthread_self(),
						srv_force_recovery, srv_use_doublewrite_buf, srv_use_checksums);
	...
	sql_print_information("%s[%d] [tid:%lu]: row_rollback_on_timeout = %d, srv_locks_unsafe_for_binlog = %d.",
							__FILE__, __LINE__, pthread_self(),
							row_rollback_on_timeout, srv_locks_unsafe_for_binlog);

	srv_max_n_open_files = (ulint) innobase_open_files;
	srv_innodb_status = (ibool) innobase_create_status_file;

	sql_print_information("%s[%d] [tid:%lu]: srv_max_n_open_files = %u, srv_innodb_status = %d.",
							__FILE__, __LINE__, pthread_self(),
							srv_max_n_open_files, srv_innodb_status);
	...
	sql_print_information("%s[%d] [tid:%lu]: data_mysql_default_charset_coll = %u.",
								__FILE__, __LINE__, pthread_self(),
	...
	sql_print_information("%s[%d] [tid:%lu]: innobase_old_blocks_pct = %u.",
									__FILE__, __LINE__, pthread_self(),
	...
	sql_print_information("%s[%d] [tid:%lu]: Try to startup innobase..", __FILE__, __LINE__, pthread_self());

	err = innobase_start_or_create_for_mysql(); //开始启动InnoDB存储引擎
	...
	uchar*	record)	/*!< in: a row in MySQL format */
{
	...
	sql_print_information("%s[%d] [tid: %lu]: Writing a MySQL format record into InnoDB Storage...", __FILE__, __LINE__, pthread_self());
...
no_commit:
	...
	sql_print_information("%s[%d] [tid: %lu]: auto_inc_used = %d, insert_error = %u...", __FILE__, __LINE__, pthread_self(), auto_inc_used, error);
	...
	stat_print_fn *stat_print)
{
	...
	sql_print_information("%s[%d] [tid:%lu]: Executing the SHOW INNODB STATUS command..", __FILE__, __LINE__, pthread_self());
	...
	sql_print_information("%s[%d] [tid:%lu]: InnoDB Status:\n %s", __FILE__, __LINE__, pthread_self(), str);
						...
						from check function */
{
	...
	sql_print_information("%s[%d] [tid:%lu]: Set system variable innobase_old_blocks_pct = %u.", __FILE__, __LINE__, pthread_self(), innobase_old_blocks_pct);
}
