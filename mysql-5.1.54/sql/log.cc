...
void LOGGER::init_base()
{
  ...
  printf("%s[%d] [tid: %lu]: Initializing basic logger..\n", __FILE__, __LINE__, pthread_self());
  ...
  */
  if (!file_log_handler){
	...
	printf("%s[%d] [tid: %lu]: Creating file log handler..\n", __FILE__, __LINE__, pthread_self());
...
void LOGGER::init_log_tables()
{
  ...
  printf("%s[%d] [tid: %lu]: Initializing table/file log handler..\n", __FILE__, __LINE__, pthread_self());

  if (!table_log_handler){
	printf("%s[%d] [tid: %lu]: Creating table log handler..\n", __FILE__, __LINE__, pthread_self());
...
void LOGGER::init_error_log(uint error_log_printer)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Initializing error log {error_log_printer = %d}...", __FILE__, __LINE__, pthread_self(), error_log_printer);
...
void LOGGER::init_slow_log(uint slow_log_printer)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Initializing slow log {slow_log_printer = %d}...", __FILE__, __LINE__, pthread_self(), slow_log_printer);
...
void LOGGER::init_general_log(uint general_log_printer)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Initializing general log {general_log_printer = %d}...", __FILE__, __LINE__, pthread_self(), general_log_printer);
                         ...
                         uint general_log_printer)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: error_log_printer = %d, slow_log_printer = %d, general_log_printer = %d.", __FILE__, __LINE__, pthread_self(), error_log_printer, slow_log_printer, general_log_printer);
...
File open_binlog(IO_CACHE *log, const char *log_file_name, const char **errmsg)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Opening the binlogs[%s]...", __FILE__, __LINE__, pthread_self(), log_file_name);
                     ...
                     const char *new_name, enum cache_type io_cache_type_arg)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to open file [%s]...", __FILE__, __LINE__, pthread_self(), log_file_name);
                         ...
                         bool need_mutex)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Opening mysql bin log{log_name = %s, new_name = %s}...", __FILE__, __LINE__, pthread_self(), log_name, new_name);
...

  {
	...
	In this case we write a standard header to it.
      */
      ...
      sql_print_information("%s[%d] [tid:%lu]: write BINLOG_MAGIC to [%s](%lu)", __FILE__, __LINE__, pthread_self(), log_file_name, bytes_written);

    }

    sql_print_information("%s[%d] [tid:%lu]: need_start_event = %d, no_auto_events = %d", __FILE__, __LINE__, pthread_self(), need_start_event, no_auto_events);
    ...
    if (need_start_event && !no_auto_events)
    {
      ...
      */
      ...
      sql_print_information("%s[%d] [tid:%lu]: write BINLOG_VERSION to [%s](%lu)", __FILE__, __LINE__, pthread_self(), log_file_name, bytes_written);
        ...
        description_event_for_queue->binlog_version>=4)
    {
      ...
      */
      ...
      sql_print_information("%s[%d] [tid:%lu]: write description_log_event to [%s](%lu)", __FILE__, __LINE__, pthread_self(), log_file_name, bytes_written);
    }
    ...
    sql_print_information("%s[%d] [tid:%lu]: write_file_name_to_index_file = %d", __FILE__, __LINE__, pthread_self(), write_file_name_to_index_file);
                                     ...
                                     bool need_mutex)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to purge bin logs...", __FILE__, __LINE__, pthread_self());
  ...
  for (;;)
  {
    ...
    else
    {
      if ((error= find_log_pos(&check_log_info, log_info.log_file_name, need_mutex)))
      {
        ...
        sql_print_information("%s[%d] [tid:%lu]: Try to purge bin log [%s]...", __FILE__, __LINE__, pthread_self(), log_info.log_file_name);
...
bool MYSQL_BIN_LOG::append(Log_event* ev)
{
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: write Event[%s] to [%s](%lu)", __FILE__, __LINE__, pthread_self(), ev->get_type_str(), log_file_name, bytes_written);
...
bool MYSQL_BIN_LOG::appendv(const char* buf, uint len,...)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: write Value[%s] to [%s](%lu)", __FILE__, __LINE__, pthread_self(), buf, log_file_name, bytes_written);
                                                ...
                                                Rows_log_event* event)
{
  ...
  if (Rows_log_event* pending= trx_data->pending())
  {
    ...
    */
    ...
    sql_print_information("%s[%d] [tid:%lu]: write Event[%s](%d) to [%s](%lu)", __FILE__, __LINE__, pthread_self(), pending->get_type_str(), pending->get_data_size(), log_file_name, file->pos_in_file);
  ...
  */
  if (likely(is_open()))
  {
    ...
    */
    ...
    sql_print_information("%s[%d] [tid:%lu]: write Event[%s](%d) to [%s](%lu)", __FILE__, __LINE__, pthread_self(), event_info->get_type_str(), event_info->get_data_size(), log_file_name, file->pos_in_file);
  ...
  if (likely(is_open()))                       // Should always be true
  {
    ...
    if (my_b_tell(cache) > 0)
    {
      ...
      */
      ...
      sql_print_information("%s[%d] [tid:%lu]: write Event[%s](%d) to [%s](%lu)", __FILE__, __LINE__, pthread_self(), qinfo.get_type_str(), qinfo.get_data_size(), log_file_name, log_file.pos_in_file);
      ...
      if(commit_event)
    	  sql_print_information("%s[%d] [tid:%lu]: write Event[%s](%d) to [%s](%lu)", __FILE__, __LINE__, pthread_self(), commit_event->get_type_str(), commit_event->get_data_size(), log_file_name, log_file.pos_in_file);
                                   ...
                                   FILE *outstream, FILE *errstream)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to open<a+> file: %s...", __FILE__, __LINE__, pthread_self(), filename);
