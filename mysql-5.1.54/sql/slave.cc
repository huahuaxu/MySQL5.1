...
int init_slave()
{
  ...
  sql_print_information("%s[%d] [tid: %lu]: Initializing slave structures...", __FILE__, __LINE__, pthread_self());
  ...
  */
  ...
  sql_print_information("%s[%d] [tid: %lu]: use_slave_mask = %d", __FILE__, __LINE__, pthread_self(), use_slave_mask);
  ...
  */
  ...
  sql_print_information("%s[%d] [tid: %lu]: master_info_file = [%s], relay_log_info_file = [%s].", __FILE__, __LINE__, pthread_self(), master_info_file, relay_log_info_file);
  ...
  sql_print_information("%s[%d] [tid: %lu]: master_host = [%s], opt_skip_slave_start = %d.", __FILE__, __LINE__, pthread_self(), master_host, opt_skip_slave_start);
                        ...
                        const char* slave_info_fname, int thread_mask)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Start to start slave threads {master_info_fname = %s, slave_info_fname = %s}...", __FILE__, __LINE__, pthread_self(), master_info_fname, slave_info_fname);
  ...
  if (thread_mask & SLAVE_IO){
	...
	sql_print_information("%s[%d] [tid:%lu]: create Slave IO thread ...", __FILE__, __LINE__, pthread_self());
  ...
  if (!error && (thread_mask & SLAVE_SQL)){
	...
	sql_print_information("%s[%d] [tid:%lu]: create Slave SQL thread...", __FILE__, __LINE__, pthread_self());
...
static int get_master_version_and_clock(MYSQL* mysql, Master_info* mi)
{
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: server_version = %s.", __FILE__, __LINE__, pthread_self(), mysql->server_version);
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: clock_diff_with_master = %ld.", __FILE__, __LINE__, pthread_self(), mi->clock_diff_with_master);
  ...
  */
  ...
  if (!mysql_real_query(mysql,
      ...
      (master_row= mysql_fetch_row(master_res)))
  {
	  sql_print_information("%s[%d] [tid:%lu]: master_serverid = %ld.", __FILE__, __LINE__, pthread_self(), strtoul(master_row[1], 0, 10));
                             ...
                             bool *suppress_warnings)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: registering slave on master{report_host = %s}...", __FILE__, __LINE__, pthread_self(), report_host);
  ...
  *suppress_warnings= FALSE;
  ...
  if (report_host_len + report_user_len + report_password_len + 30 >
      sizeof(buf)){
	  sql_print_information("%s[%d] [tid:%lu]: safety...", __FILE__, __LINE__, pthread_self());
  ...
  sql_print_information("%s[%d] [tid:%lu]: sending Command[COM_REGISTER_SLAVE] to master..", __FILE__, __LINE__, pthread_self());
                        ...
                        bool *suppress_warnings)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Requesting binlog dump from master...", __FILE__, __LINE__, pthread_self());
  ...
  *suppress_warnings= FALSE;
  ...
  sql_print_information("%s[%d] [tid:%lu]: Sending Command[COM_BINLOG_DUMP] to master...", __FILE__, __LINE__, pthread_self());
...
int apply_event_and_update_pos(Log_event* ev, THD* thd, Relay_log_info* rli)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: try to apply the relay_log_event{relay_log_file='%s', relay_log_pos='%ld'}{%s(type_code: %d; server_id: %d)}...",
        		__FILE__, __LINE__, pthread_self(),
				rli->group_relay_log_name, (ulong) rli->group_relay_log_pos, ev->get_type_str(), ev->get_type_code(), ev->server_id);
...
static int exec_relay_log_event(THD* thd, Relay_log_info* rli)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: executing the relay_log_event{relay_log_file='%s', relay_log_pos='%ld'}...",
      		__FILE__, __LINE__, pthread_self(), rli->group_relay_log_name, (ulong) rli->group_relay_log_pos);
...
pthread_handler_t handle_slave_io(void *arg)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: start Slave I/O Thread...", __FILE__, __LINE__, pthread_self());
  ...
  sql_print_information("%s[%d] [tid:%lu]: [Slave I/O thread] try to connect master '%s@%s:%d', replication started in log '%s' at position %s", __FILE__, __LINE__, pthread_self(),
  ...
  */
    ...
    sql_print_information("%s[%d] [tid:%lu]: [Slave I/O thread] max_packet_size = %ld", __FILE__, __LINE__, pthread_self(), mysql->net.max_packet_size);
  }
  else
  {
...
connected:
  ...
  sql_print_information("%s[%d] [tid:%lu]: [Slave I/O thread] try to check master version/clock/serverid..", __FILE__, __LINE__, pthread_self());
  ...
  if (mi->rli.relay_log.description_event_for_queue->binlog_version > 1)
  {
    ...
    */
    ...
    sql_print_information("%s[%d] [tid:%lu]: [Slave I/O thread] try to register slave on master..", __FILE__, __LINE__, pthread_self());
  ...
  while (!io_slave_killed(thd,mi))
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: [Slave I/O thread] try to request binlog dump from master..", __FILE__, __LINE__, pthread_self());
...
pthread_handler_t handle_slave_sql(void *arg)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: [Slave SQL Thread] start Slave SQL Thread...", __FILE__, __LINE__, pthread_self());
...
log '%s' at position %s, relay log '%s' position: %s", RPL_LOG_NAME,
  ...
  */
  ...
  while (!sql_slave_killed(thd,rli))
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: [Slave SQL Thread] try to execute a relay_log_event{relay_log_file='%s', relay_log_pos='%ld', master_log_name='%s',master_log_pos='%ld'}...",
    		__FILE__, __LINE__, pthread_self(),
			rli->group_relay_log_name, (ulong) rli->group_relay_log_pos, rli->group_master_log_name, (ulong) rli->group_master_log_pos);
