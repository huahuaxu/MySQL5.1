                                      ...
                                      const char *query_arg, uint32 q_len_arg)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: applying the relay_log_event{relay_log_file='%s', relay_log_pos='%ld'}...",
...
bool Rows_log_event::write_data_header(IO_CACHE *file)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Writing Rows_log_event header {m_table_id = %lu, m_flags = %d}...", __FILE__, __LINE__, pthread_self(), m_table_id, m_flags);
...
bool Rows_log_event::write_data_body(IO_CACHE*file)
{
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: Writing Rows_log_event databody {size = %d, type = %d(%s)}...", __FILE__, __LINE__, pthread_self(), data_size, get_type_code(), get_type_str());
