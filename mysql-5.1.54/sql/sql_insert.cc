...
bool open_and_lock_for_insert_delayed(THD *thd, TABLE_LIST *table_list)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to open and lock for delayed insert from client(%s) ...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
		  ...
		  bool ignore)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Processing the INSERT statement from client(%s) ...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");

  sql_print_information("%s[%d] [tid:%lu]: The Query_SQL = [%s] from client(%s) ...", __FILE__, __LINE__, pthread_self(), thd->query(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to upgrade lock, {lock_type = %d, duplic = %d, values = %d} from client(%s) ...", __FILE__, __LINE__, pthread_self(), table_list->lock_type, duplic, values_list.elements, thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: The lock_type = %d from client(%s) ...", __FILE__, __LINE__, pthread_self(), table_list->lock_type, thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
int write_record(THD *thd, TABLE *table,COPY_INFO *info)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Writing record {handle_duplicates = %d} from client(%s)...", __FILE__, __LINE__, pthread_self(), info->handle_duplicates, thd->net.vio? thd->net.vio->_debug_ip_port:"");
