...
bool mysqld_show_authors(THD *thd)
{
  ...
  sql_print_information("%s[%d] [tid: %lu]: Executing SHOW_COMMAND {show authors}", __FILE__, __LINE__, pthread_self());
...
bool mysqld_show_contributors(THD *thd)
{
  ...
  sql_print_information("%s[%d] [tid: %lu]: Executing SHOW_COMMAND {show contributors}", __FILE__, __LINE__, pthread_self());
...
bool mysqld_show_privileges(THD *thd)
{
  ...
  sql_print_information("%s[%d] [tid: %lu]: Executing SHOW_COMMAND {show privileges}", __FILE__, __LINE__, pthread_self());
