                         ...
                         handlerton *db_type)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to create a new table Handler {db = %s, table = %s}.", __FILE__, __LINE__, pthread_self(),
		  share? share->db.str:"NULL", share? share->table_name.str:"NULL");
...
int handler::ha_update_row(const uchar *old_data, uchar *new_data)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Writing Update_rows_log_event for Update...", __FILE__, __LINE__, pthread_self());
...
int handler::ha_delete_row(const uchar *buf)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Writing Rows_log_event for Delete...", __FILE__, __LINE__, pthread_self());
