...
bool do_command(THD *thd)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Processing a new query from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio->_debug_ip_port);
  ...
  */
  sql_print_information("%s[%d] [tid:%lu]: Setting timeout %u s for read from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->variables.net_wait_timeout, thd->net.vio->_debug_ip_port);
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to read a package from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio->_debug_ip_port);

  packet_length= my_net_read(net);

  sql_print_information("%s[%d] [tid:%lu]: Read %ul bytes from client(%s)...", __FILE__, __LINE__, pthread_self(), packet_length, thd->net.vio->_debug_ip_port);
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: the Command on %s = %d (%s) from client(%s)...", __FILE__, __LINE__, pthread_self(), vio_description(net->vio), command,
          command_name[command].str, thd->net.vio->_debug_ip_port);
		      ...
		      char* packet, uint packet_length)
{
  ...
  */
  ...
  case COM_INIT_DB:
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: The Command [COM_INIT_DB] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio->_debug_ip_port);
  ...
  case COM_QUERY:
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: The SQL '%s' from client(%s)...\n", __FILE__, __LINE__, pthread_self(), thd->query(), thd->net.vio->_debug_ip_port);
  ...
  case COM_CREATE_DB:				// QQ: To be removed
    {
      ...
      sql_print_information("%s[%d] [tid:%lu]: The Command [COM_CREATE_DB] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio->_debug_ip_port);
  ...
  case COM_DROP_DB:				// QQ: To be removed
    {
      ...
      sql_print_information("%s[%d] [tid:%lu]: The Command [COM_DROP_DB] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio->_debug_ip_port);
...
mysql_execute_command(THD *thd)
{
  ...
  */
  ...
  case SQLCOM_CREATE_TABLE:
  {
	...
	sql_print_information("%s[%d] [tid: %lu]: Try to execute command [CREATE_TABLE]...\n", __FILE__, __LINE__, pthread_self());
                 ...
                 const char ** found_semicolon)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Parsing the SQL '%s' from client(%s)...\n", __FILE__, __LINE__, pthread_self(), rawbuf, thd->net.vio->_debug_ip_port);
  ...
  */
  ...
  if (query_cache_send_result_to_client(thd, rawbuf, length) <= 0)	//未命中缓存
  {
    LEX *lex= thd->lex;
	...
	if (! thd->is_error())
	{
          ...
          */
          ...
          sql_print_information("%s[%d] [tid:%lu]: Try to execute the SQL '%s' from client(%s)...", __FILE__, __LINE__, pthread_self(), rawbuf, thd->net.vio->_debug_ip_port);
                           ...
                           TABLE_LIST *create_table)
{
  ...
  */
  ...
  sql_print_information("%s[%d] [tid: %lu]: Checking the privilege for creating table [%s]...\n", __FILE__, __LINE__, pthread_self(), create_table->table_name);
