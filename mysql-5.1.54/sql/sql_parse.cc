...
bool do_command(THD *thd)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try process a new query from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: read_timeout = %d from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->variables.net_wait_timeout, thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  */
  my_net_set_read_timeout(net, thd->variables.net_wait_timeout);  //在读取客户端新的请求之前先设置读超时
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to read a package from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: the Command on %s = %d (%s) from client(%s)...", __FILE__, __LINE__, pthread_self(), vio_description(net->vio), command,
          command_name[command].str, thd->net.vio? thd->net.vio->_debug_ip_port:"");
		      ...
		      char* packet, uint packet_length)
{
  ...
  */
  ...
  case COM_INIT_DB:
  {
    ...
    thd->convert_string(&tmp, system_charset_info, packet, packet_length, thd->charset());
  ...
  {
	sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[COM_REGISTER_SLAVE] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  case COM_QUERY:
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: The SQL '%s' from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->query(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  case COM_BINLOG_DUMP:
    {
      ...
      sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[COM_BINLOG_DUMP] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
	...
	kill_zombie_dump_threads(slave_server_id);
      ...
      sql_print_information("%s[%d] [tid:%lu]: COM_BINLOG_DUMP={log = %s, pos = %d, flags = %d, slave_server_id = %d} from client(%s)...", __FILE__, __LINE__, pthread_self(), packet+10, pos, flags, slave_server_id, thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
mysql_execute_command(THD *thd)
{
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: The SQL_COMMAND = %d from client(%s)...", __FILE__, __LINE__, pthread_self(), lex->sql_command, thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  case SQLCOM_SELECT:
    ...
    sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[SQLCOM_SHOW_*] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");

    sql_print_information("%s[%d] [tid:%lu]: Start to check the access privileges from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  case SQLCOM_CHANGE_MASTER:
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[SQLCOM_CHANGE_MASTER] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
end_with_restore_list:
  ...
  */
  ...
  case SQLCOM_SLAVE_START:
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[SQLCOM_SLAVE_START] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  */
  ...
  case SQLCOM_UPDATE:
    ...
    sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[SQLCOM_UPDATE] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  case SQLCOM_INSERT:
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[SQLCOM_INSERT] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  case SQLCOM_DELETE:
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[SQLCOM_DELETE] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  case SQLCOM_KILL:
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: Try to process the Command[SQLCOM_KILL] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
static bool execute_sqlcom_select(THD *thd, TABLE_LIST *all_tables)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Processing the Command[SQLCOM_SELECT*] from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  /* assign global limit variable if limit is not given */
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: explicit_limit = %d, select_limit = %lu from client(%s)...", __FILE__, __LINE__, pthread_self(), param->explicit_limit, thd->variables.select_limit, thd->net.vio? thd->net.vio->_debug_ip_port:"");

  }

  if (!(res= open_and_lock_tables(thd, all_tables)))
  {
    sql_print_information("%s[%d] [tid:%lu]: describe = %d from client(%s)...", __FILE__, __LINE__, pthread_self(), lex->describe, thd->net.vio? thd->net.vio->_debug_ip_port:"");
                 ...
                 const char ** found_semicolon)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Parsing the SQL '%s' from client(%s)...", __FILE__, __LINE__, pthread_self(), rawbuf, thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  */
  ...
  if (query_cache_send_result_to_client(thd, rawbuf, length) <= 0)	//命中缓存
  {
    LEX *lex= thd->lex;
	...
	if (! thd->is_error())
	{
          ...
          */
          ...
          sql_print_information("%s[%d] [tid:%lu]: Try to execute the SQL '%s' from client(%s)...", __FILE__, __LINE__, pthread_self(), rawbuf, thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
uint kill_one_thread(THD *thd, ulong id, bool only_kill_query)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Killing the thread {id = %ld, only_kill_query = %d} from client(%s)...", __FILE__, __LINE__, pthread_self(), id, only_kill_query, thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
void sql_kill(THD *thd, ulong id, bool only_kill_query)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to kill a thread {id = %ld, only_kill_query = %d}  from client(%s)...", __FILE__, __LINE__, pthread_self(), id, only_kill_query, thd->net.vio? thd->net.vio->_debug_ip_port:"");
