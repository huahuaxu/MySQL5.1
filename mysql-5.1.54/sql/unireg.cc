		      ...
		      handler *db_file)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Start to create a frm (table definition) file [%s] for table '%s'.'%s'...", __FILE__, __LINE__, pthread_self(), file_name, db, table);
                     ...
                     uint keys, KEY *key_info, handler *file)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Start to create table '%s'.'%s'...", __FILE__, __LINE__, pthread_self(), db, table_name);
