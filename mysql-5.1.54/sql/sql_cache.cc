...
Query_cache::send_result_to_client(THD *thd, char *sql, uint query_length)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Check if the query '%s' is in the cache from client(%s)...", __FILE__, __LINE__, pthread_self(), sql, thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
ulong Query_cache::init_cache()
{
  ...
  printf("%s[%d] [tid: %lu]: Initializing query cache...\n", __FILE__, __LINE__, pthread_self());
