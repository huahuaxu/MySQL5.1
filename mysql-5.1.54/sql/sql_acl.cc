...
static my_bool acl_load(THD *thd, TABLE_LIST *tables)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Start to load ACL...", __FILE__, __LINE__, pthread_self());
  ...
  sql_print_information("%s[%d] [tid:%lu]: Loading ACL from table %s.%s...", __FILE__, __LINE__, pthread_self(), tables[0].db, tables[0].table_name);
  ...
  while (!(read_record_info.read_record(&read_record_info)))
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: Added a ACL record Host(%s)------>DB(%s)...", __FILE__, __LINE__, pthread_self(), host.host.hostname, host.db);
  ...
  sql_print_information("%s[%d] [tid:%lu]: Loading ACL from table %s.%s...", __FILE__, __LINE__, pthread_self(), tables[1].db, tables[1].table_name);
  ...
  while (!(read_record_info.read_record(&read_record_info)))
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: Added a ACL record Host(%s)------>User(%s)...", __FILE__, __LINE__, pthread_self(), user.host.hostname, user.user);
  ...
  sql_print_information("%s[%d] [tid:%lu]: Loading ACL from table %s.%s...", __FILE__, __LINE__, pthread_self(), tables[2].db, tables[2].table_name);
  ...
  while (!(read_record_info.read_record(&read_record_info)))
  {
    ...
    sql_print_information("%s[%d] [tid:%lu]: Added a ACL record Host(%s)------>DB(%s)...", __FILE__, __LINE__, pthread_self(), db.host.hostname, db.db);
                ...
                const char *passwd, uint passwd_len)
{
  ...
  if (!initialized)
  {
    ...
    */
	sql_print_information("%s[%d] [tid:%lu]: skip-grant-tables for client(%s)...", __FILE__, __LINE__, pthread_self(), thd->net.vio->_debug_ip_port);
  ...
  */
  sql_print_information("%s[%d] [tid:%lu]: username = %s, host = %s, ip = %s for client(%s)...", __FILE__, __LINE__, pthread_self(), sctx->user, sctx->host, sctx->ip, thd->net.vio->_debug_ip_port);
