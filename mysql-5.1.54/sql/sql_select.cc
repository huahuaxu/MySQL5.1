                   ...
                   ulong setup_tables_done_option)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Handle the select {%s} ===> {is_union = %d} from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->query(), select_lex->master_unit()->is_union(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
	      ...
	      SELECT_LEX_UNIT *unit_arg)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Preparing the join for the select {%s} from client(%s)...", __FILE__, __LINE__, pthread_self(), this->thd->query(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
JOIN::optimize()
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Optimizing the join for the select {%s} from client(%s)...", __FILE__, __LINE__, pthread_self(), this->thd->query(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
...
JOIN::exec()
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Executing the join for the select {%s} from client(%s)...", __FILE__, __LINE__, pthread_self(), this->thd->query(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
  ...
  */
  ...
  sql_print_information("%s[%d] [tid:%lu]: limit_found_rows = %lu, examined_row_count = %lu for the select {%s} from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->limit_found_rows, thd->examined_row_count, this->thd->query(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
	     ...
	     SELECT_LEX *select_lex)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Executing the select(without UNION) {%s} from client(%s)...", __FILE__, __LINE__, pthread_self(), thd->query(), thd->net.vio? thd->net.vio->_debug_ip_port:"");
