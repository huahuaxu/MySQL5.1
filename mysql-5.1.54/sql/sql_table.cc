...
static uint read_ddl_log_header()
{
  ...
  sql_print_information("%s[%d] [tid: %lu]: Try to read the head of ddl log [%s]...", __FILE__, __LINE__, pthread_self(), file_name);
...
void execute_ddl_log_recovery()
{
  ...
  sql_print_information("%s[%d] [tid: %lu]: Executing the ddl log to receovery...", __FILE__, __LINE__, pthread_self(), file_name);
                                             ...
                                             bool internal_tmp_table)
{
	...
	sql_print_information("%s[%d] [tid:%lu]: Writing CREATE TABLE binlog...", __FILE__, __LINE__, pthread_self());
                                ...
                                uint select_field_count)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to create table '%s'.'%s' with no lock...", __FILE__, __LINE__, pthread_self(), db, table_name);
                        ...
                        uint select_field_count)
{
  ...
  sql_print_information("%s[%d] [tid:%lu]: Try to create table '%s'.'%s'...", __FILE__, __LINE__, pthread_self(), db, table_name);
