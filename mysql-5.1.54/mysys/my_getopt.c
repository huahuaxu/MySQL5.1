                   ...
                   my_get_one_option get_one_option)
{
  ...
  my_getopt_error_reporter(INFORMATION_LEVEL, "%s[%d] [tid:%lu]: Handling options...", __FILE__, __LINE__, pthread_self());
                           ...
                           init_func_p init_one_value)
{
  ...
  my_getopt_error_reporter(INFORMATION_LEVEL, "%s[%d] [tid:%lu]: Initializing all variables to their default values...", __FILE__, __LINE__, pthread_self());

  //const struct my_option *tmpOptions = options;
